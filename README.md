...
access, procurement and maintenance-lite workflows. It is not production-ready,
does not implement auth/RBAC/tenant isolation, and does not call real enterprise
systems by default.
